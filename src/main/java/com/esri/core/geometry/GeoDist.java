...
final class GeoDist {
	...
	/**
	 * public version of the private method lam_delta (used for testing)
	 * @param lam
	 * @return
	 */
	public static double public_lam_delta(double lam) {
		return lam_delta(lam);
	}

	/**
	 * public access to private method q90 (used for testing)
	 * @param a
	 * @param e2
	 * @return
	 */
	public static double public_q90(double a, double e2) {
		return q90(a, e2);
	}

	public static void public_lam_phi_reduction(PeDouble p_lam, PeDouble p_phi) {
		lam_phi_reduction(p_lam, p_phi);
	}
}
